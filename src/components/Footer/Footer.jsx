  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
        <h2 className="text-xl font-semibold text-purple-500">Ekta Teli</h2>
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/ektateli1911/" },
            { icon: <FaGithub />, link: "https://github.com/ektateli?tab=repositories" },
        ...
        <p className="text-sm text-gray-400 mt-6">
          © 2025 Ekta Teli. All rights reserved.
        </p>
      </div>
    </footer>
  );
